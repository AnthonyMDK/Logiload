      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav  ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="fruit.html">Logiciel</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="blog.html">Avis</a>
            </li>
            <li class="nav-item">
  ...
  <section class="product_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Voici nos meilleur vente du mois
        </p>
      </div>
      <div class="row">
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            ...
            <input id ="buttonul" type="submit" value="Photoshop" name = "ref"></input>
              </form>
              <div class="price_box">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <form method="POST" action="squelette_page.php">
            <input id ="buttonul" type="submit" value="Gimp" name = "ref"></input>
              </form>
              <div class="price_box">
                <h6 class="price_heading">
                  <span>$</span> 10.00
